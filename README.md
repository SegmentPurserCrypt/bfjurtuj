...
<p align="center">
  <img width="1379" height="954" alt="image" src="https://github.com/user-attachments/assets/0580eba6-0250-43c6-a9bf-34cf54d9f37c" />
...
```mermaid
graph LR
    A[Launch Genshin Impact] --> B[Run Akasha Terminal]
    B --> C{Select Blessing Profile}
    C -->|Exploration Mode| D[Ley Line Sensing & Auto-Loot]
    C -->|Abyss Mode| E[Instant Burst & Skill Resonance]
    D --> F[Active World Analytics]
    E --> F[Domain Completed]
```
...
<img width="1376" height="954" alt="image" src="https://github.com/user-attachments/assets/a9173f54-471e-4ebe-b81f-2d99aa00c608" />
